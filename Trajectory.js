     ...
     elements: [
      {
       type: "html",
       name: "group_50",
       html: "<h3 style=\"font-weight: 500;\">Q1. Using the graph below, please answer these <strong>two</strong> questions:</h3>\n<span>\n<img style=\"width: 500px;margin-top: 20px;\" src=\"https://www.dropbox.com/s/vsnl5ttrfqxbkhr/Output%2050%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "50_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "group_19",
       html: "<h3 style=\"font-weight: 500;\">Q2. Using the graph below, please answer these <strong>two</strong> questions:</h3>\n<span>\n<img style=\"width: 500px;margin-top: 20px;\" src=\"https://www.dropbox.com/s/3jnhhhu345liovy/Output%2019%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "19_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question42",
       html: "<h3 style=\"font-weight: 500;\">Q3. Using the graph below, please answer these <strong>two</strong> questions:</h3>\n<span>\n<img style=\"width: 500px;margin-top: 20px;\" src=\"https://www.dropbox.com/s/6sejjjt1xqe308v/Output%2041%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "41_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question54",
       html: "<h3 style=\"font-weight: 500;\">Q4. Using the graph below, please answer these <strong>two</strong> questions:</h3>\n<span>\n<img style=\"width: 500px;margin-top: 20px;\" src=\"https://www.dropbox.com/s/c909iqo3x838cxx/Output%204%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "4_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question63",
       html: "<h3 style=\"font-weight: 500;\">Q5. Using the graph below, please answer these <strong>two</strong> questions:</h3>\n<span>\n<img style=\"width: 500px;margin-top: 20px;\" src=\"https://www.dropbox.com/s/p8azm3eg4pa31gm/Output%2069%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "69_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question11",
       html: "<h3 style=\"font-weight: 500;\">Q6. Using the graph below, please answer these <strong>two</strong> questions:</h3>\n<span>\n<img style=\"width: 500px;margin-top: 20px;\" src=\"https://www.dropbox.com/s/u6r6vsomggpeu25/Output%209%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "9_1_a",
...
var surveyJSON = {}
surveyJSON["bundle"] = [trajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
surveyJSON["trajectory"] = [trajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
surveyJSON["bundlePlustrajectory"] = [trajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
surveyJSON["morphing"] = [trajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
