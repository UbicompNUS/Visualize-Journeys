     ...
     elements: [
      {
       type: "html",
       name: "group_50",
       html: "<h3 style=\"font-weight: 500;\">Q1. The left image shows grouped journeys and the right image shows the heat map of their traces on roads. Please use the two images to answer these <strong>two</strong> questions:</h3>\n<span><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/a47wjkw8skievfo/Output%2050%20First_00000.png?raw=1\" /><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/vsnl5ttrfqxbkhr/Output%2050%20Last_00000.png?raw=1\" /> </span>"
      },
      {
       type: "checkbox",
       name: "50_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "group_19",
       html: "<h3 style=\"font-weight: 500;\">Q2. The left image shows grouped journeys and the right image shows the heat map of their traces on roads. Please use the two images to answer these <strong>two</strong> questions:</h3>\n<span><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/grcieylrk1kvqzc/Output%2019%20First_00000.png?raw=1\" /><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/3jnhhhu345liovy/Output%2019%20Last_00000.png?raw=1\" /> </span>\n"
      },
      {
       type: "checkbox",
       name: "19_1_a",
      ...
      },
      {
       type: "text",
       name: "19_1_b",
       title: "2b. A6contains the start points of some journeys. Please find all the grid squares that contains the end points of those journeys.",
       description: "Could be multiple answers. Please separate different answers with a comma, like A1,A2\n",
       validators: [
        {
         type: "regex",
     ...
     elements: [
      {
       type: "html",
       name: "question42",
       html: "<h3 style=\"font-weight: 500;\">Q3. The left image shows grouped journeys and the right image shows the heat map of their traces on roads. Please use the two images to answer these <strong>two</strong> questions:</h3>\n<span><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/spiugd6maqthi05/Output%2041%20First_00000.png?raw=1\" /><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/6sejjjt1xqe308v/Output%2041%20Last_00000.png?raw=1\" /> </span>"
      },
      {
       type: "checkbox",
       name: "41_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question54",
       html: "<h3 style=\"font-weight: 500;\">Q4. The left image shows grouped journeys and the right image shows the heat map of their traces on roads. Please use the two images to answer these <strong>two</strong> questions:</h3>\n<span><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/b80jva6025lfvm0/Output%204%20First_00000.png?raw=1\" /><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/c909iqo3x838cxx/Output%204%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "4_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question63",
       html: "<h3 style=\"font-weight: 500;\">Q5. The left image shows grouped journeys and the right image shows the heat map of their traces on roads. Please use the two images to answer these <strong>two</strong> questions:</h3>\n<span><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/9wu72x1lwq1vw3f/Output%2069%20First_00000.png?raw=1\" /><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/p8azm3eg4pa31gm/Output%2069%20Last_00000.png?raw=1\" /></span>\n"
      },
      {
       type: "checkbox",
       name: "69_1_a",
     ...
     elements: [
      {
       type: "html",
       name: "question11",
       html: "<h3 style=\"font-weight: 500;\">Q6. The left image shows grouped journeys and the right image shows the heat map of their traces on roads. Please use the two images to answer these <strong>two</strong> questions:</h3>\n<span><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/fiv7ifhhjh1d30e/Output%209%20First_00000.png?raw=1\" /><img style=\"width: 399px;margin-top: 20px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;\" src=\"https://www.dropbox.com/s/u6r6vsomggpeu25/Output%209%20Last_00000.png?raw=1\" /></span>"
      },
      {
       type: "checkbox",
       name: "9_1_a",
   ...
   elements: [
    {
     ...
     elements: [
      ...
      },
      {
       type: "text",
       name: "4_3_c",
       title: "5b. \nPlease identify the other three grid squares that you think most of the journeys had to pass through.",
       description: "Could be multiple answers. Please separate different answers with a comma, like A1,A2",
       validators: [
        {
         type: "regex",
  ...
  },
  {
   ...
   elements: [
    ...
    },
    {
     ...
     name: "Technique",
     visible: false,
     defaultValue: "BundlePlusTrajectory"
    }
   ]
  }
 ],
...
var surveyJSON = {}
surveyJSON["bundle"] = [bundlePlustrajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
surveyJSON["trajectory"] = [bundlePlustrajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
surveyJSON["bundlePlustrajectory"] = [bundlePlustrajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
surveyJSON["morphing"] = [bundlePlustrajectoryJSON, "0790e1a8-4ad9-475a-be5d-8e23c1108528"]
